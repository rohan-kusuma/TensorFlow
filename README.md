...
This means, from now on, TensorFlow code can be used and debugged asas  as ordinary python code (using numpy for example). This is one aspect of making TensorFlow more pythonic.
